...
def train_model(model, criterion, optimizer, dataloaders,num_epochs):
    ...
    plt.legend()
    output_folder = './'
    plt.savefig(os.path.join(output_folder, 'googlenet_road_data%s_epochs.png' % num_epochs))
...
save_path_final = f'./googlenet_roaddata_weightedloss-{k}Folds{num_epochs}epochs.pth'
